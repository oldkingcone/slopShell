    ...
    function createDB()
    {
        ...
        if (empty($sloppy_ini['sloppy_db']['pass'])) {
            try {
                ...
                pg_exec($this->init_conn(), "GRANT SELECT,INSERT,UPDATE ON sloppy_bots_main,sloppy_bots_droppers,sloppy_bots_domains,sloppy_bots_tools,sloppy_bots_proxies,sloppy_bots_slim_droppers TO sloppy_bot");
