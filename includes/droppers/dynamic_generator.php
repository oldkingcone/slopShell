...
SLIMM;
                ...
                fwrite($to_out, $dr);
                fclose($to_out);
                pg_exec(pg_connect(DBCONN), sprintf("INSERT INTO sloppy_bots_slim_droppers(location_on_disk, caller_domain, cookiename, cookievalue, user_agent) VALUES ('%s', '%s', '%s', '%s', '%s')",
                        $push_out,
                        $caller,
                        $cookieName,
                        $final,
